...
export default class BirthdayCarousel extends React.Component<IBirthdayCarouselProps, {}> {
  public render(): React.ReactElement<IBirthdayCarouselProps> {
    ...
    return (
      <section className={`${styles.birthdayCarousel} ${hasTeamsContext ? styles.teams : ''}`}>
